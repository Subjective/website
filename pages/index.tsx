    ...
    <ScrollAnimationWrapper>
      <li>
        <article>
          <ClickableCard
            link={`/blog/${slug}`}
            className="xl:space-y1 mb-10 space-y-2 rounded-2xl bg-gray-100/50 px-8 py-10 backdrop-blur-sm duration-300 dark:bg-gray-800/50 sm:bg-transparent sm:backdrop-blur-none sm:hover:bg-gray-100/50 sm:hover:backdrop-blur-sm sm:dark:bg-transparent sm:dark:hover:bg-gray-800/50 xl:grid xl:grid-cols-4 xl:items-baseline"
          >
            <dl>
